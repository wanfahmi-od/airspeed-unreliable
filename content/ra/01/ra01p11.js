...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/ra01p11_video1.jpg", id:"ra01p11_video1"},
...
(lib.ra01p11_video1 = function() {
	this.initialize(img.ra01p11_video1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1110,621);
...
(lib.instruction = function(mode,startPosition,loop) {
	...
	this.shape_17.graphics.f().s("#000000").ss(1,0,0,3).p("EAyEAaMIAADtMhkHAAAIAAjtgEgyDAaMMAAAg4EMBkHAAAMAAAA4E");
	this.shape_17.setTransform(320.5,339.3);
...
p.nominalBounds = new cjs.Rectangle(-1,147,643,384.7);
...
(lib.Turb_basecopy = function(mode,startPosition,loop) {
	...
	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,0,0,3).p("EgyBgb+MBkDAAAMAAAA39MhkDAAAg");
	this.shape.setTransform(320.5,327.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(5));

	// Layer 1
	this.instance_1 = new lib.ra01p11_video1();
	this.instance_1.setTransform(0.3,148.6,0.577,0.577);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1,147,642.9,384.7);
...
// stage content:
(lib.ra01p11 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{s1:0});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(85).call(this.frame_85).wait(6).call(this.frame_91).wait(1));

	// prot
	this.prot = new lib.prot();
	this.prot.setTransform(500,275,1,1,0,0,0,500,275);

	this.timeline.addTween(cjs.Tween.get(this.prot).wait(92));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{mode:"single",loop:undefined}}]}).to({state:[{t:this.instance,p:{mode:"synched",loop:false}}]},80).to({state:[{t:this.btn1}]},5).wait(7));
